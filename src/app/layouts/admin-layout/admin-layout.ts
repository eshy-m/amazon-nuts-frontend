import { Component, inject, OnInit, OnDestroy, ChangeDetectorRef } from '@angular/core'; // 🔥 Añadido ChangeDetectorRef
...
export class AdminLayoutComponent implements OnInit, OnDestroy {
  ...
  toggleDrawer() {
    ...
    this.cdr.detectChanges(); // También forzamos al abrir/cerrar el menú móvil
  }
